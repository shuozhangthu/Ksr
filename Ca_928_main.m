...
y = lsqcurvefit(@Ca_928_function,y0,depth2,Ca2_data,lb,ub);



figure
plot(Ca_928_function(y,depth2),depth2,'linewidth',2)
set(gca,'Ydir','reverse')
title('Calcium (mM) in pore water (site:928)')
...
save('parameters_Ca_928.mat', '-struct', 'S'); 

% print -djpeg 928_Ca.jpg -r600