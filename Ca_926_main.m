...
y = lsqcurvefit(@Ca_926_function,y0,depth2,Ca2_data,lb,ub);



figure
plot(Ca_926_function(y,depth2),depth2,'linewidth',2)
set(gca,'Ydir','reverse')
title('Calcium (mM) in pore water (site:926)')
...
save('parameters_Ca_926.mat', '-struct', 'S'); 

% print -djpeg 926_Ca.jpg -r600