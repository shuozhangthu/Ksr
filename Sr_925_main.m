...
zz = lsqcurvefit(@Sr_925_function,zz0,depth,Sr/1000,lb,ub);


figure;
plot(Sr_925_function(zz,depth),depth,'linewidth',2)
hold on
scatter(Sr/1000,depth,'ko')
hold on
set(gca,'Ydir','reverse')
title("Sr concentration in pore water (site:925)")
...
newName = 'fitSr_Ksr2';
S.(newName) = Sr_925_function(zz,depth);
save('parameters_sr_925.mat', '-struct', 'S'); 
